    ...
    const fetchStats = async () => {
      try {
        ...
        if (user?.role === 'admin') {
          ...
          const pendingInvoices = invoicesList.filter(i => i.status === 'pending' || i.status === 'belum_lunas').length
          const paidInvoices = invoicesList.filter(i => i.status === 'paid' || i.status === 'lunas').length
          ...
          const totalIncome = invoicesList
            .filter(i => i.status === 'paid' || i.status === 'lunas')
          ...
          {user?.role === 'admin' ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-gray-800 font-bold text-xl">{stats.totalComplaints}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-yellow-600 text-sm">Menunggu</span>
                      <span className="text-yellow-600 font-semibold">{stats.pendingComplaints}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-green-600 text-sm">Selesai</span>
                      <span className="text-green-600 font-semibold">{stats.resolvedComplaints}</span>
                    </div>
                  </div>
                  <button 
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-500 text-sm">Total</span>
                      <span className="text-gray-800 font-bold text-xl">{stats.totalInvoices}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-red-600 text-sm">Belum Lunas</span>
                      <span className="text-red-600 font-semibold">{stats.pendingInvoices}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-green-600 text-sm">Lunas</span>
                      <span className="text-green-600 font-semibold">{stats.paidInvoices}</span>
                    </div>
                  </div>
                  <button 
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-green-600 font-semibold">{stats.availableRooms}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-blue-600 text-sm">Terisi</span>
                      <span className="text-blue-600 font-semibold">{stats.occupiedRooms}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-orange-600 text-sm">Perbaikan</span>
                      <span className="text-orange-600 font-semibold">{stats.maintenanceRooms}</span>
                    </div>
                  </div>
                  <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                ...
                <p className="text-4xl font-bold text-gray-800 mb-2">{stats.pendingInvoices}</p>
                <p className="text-gray-500 text-sm">tagihan belum lunas</p>
                <button 
