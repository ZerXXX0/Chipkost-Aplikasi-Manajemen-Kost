...
class KosSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Kos
        fields = ('id', 'name', 'address', 'owner', 'room_count', 'created_at', 'updated_at')
...
class RoomSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Room
        fields = ('id', 'kos', 'kos_name', 'room_number', 'nomor_kamar', 'floor', 'price', 'harga', 'status', 'description', 'capacity', 'facilities', 'image', 'penyewa', 'penyewa_username', 'created_at', 'updated_at')
...
class RentalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Rental
        fields = ('id', 'room', 'nomor_kamar', 'penyewa', 'penyewa_username', 'start_date', 'end_date', 'harga_bulanan', 'status', 'created_at', 'updated_at')
        read_only_fields = ('id', 'created_at', 'updated_at')
