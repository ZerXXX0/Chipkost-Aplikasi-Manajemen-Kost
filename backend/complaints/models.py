...
class Kerusakan(models.Model):
    ...
    penyewa = models.ForeignKey(User, on_delete=models.SET_NULL, related_name='laporan_kerusakan', limit_choices_to={'role': 'penyewa'}, verbose_name='Penyewa', null=True, blank=True)
